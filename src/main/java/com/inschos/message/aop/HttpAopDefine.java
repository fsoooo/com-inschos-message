package com.inschos.message.aop;
...
import com.inschos.message.assist.kit.ConstantKit;
...
public class HttpAopDefine {
    ...
    @Around("@annotation(com.inschos.message.annotation.GetActionBeanAnnotation)")
